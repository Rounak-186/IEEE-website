    ...
    return (
        <div>
            ...
            <div className='space-y-6'>
                <div>
                    <Button variant='primary' onClick={() => router.push("/admin/events/event?tab=create")}>
                        <Plus size={15} />
                        Create new Event
                    </Button>
                </div>
                    ...
                    {eventList.map((event, index) => (
                        <div className='space-y-2' key={index}>
                            <div className='p-2 bg-gray-200 rounded-xl flex items-center gap-3 justify-between'>
                                ...
                                <div>
                                    <Button variant='success' onClick={() => router.push(`/admin/events/event?tab=edit&id=${event?._id}`)}>
                                        <Pencil size={15} />
                                        Edit event
                                    </Button>
                                </div>
